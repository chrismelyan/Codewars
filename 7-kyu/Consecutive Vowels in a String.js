...
// and consecutive vowels there are in the given string beginning from "a". Keep in mind that the
// consecutive vowel to "u" is "a" and the cycle continues.
...
// The logic is that you start from the "a" and make your way right. The next vowel is an "e" and
// it is the consecutive vowel, then "i" and so forth until you get to "u". If you keep moving right
// you find "a" which happens to be the consecutive vowel. Return 6.
